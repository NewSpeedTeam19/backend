...
public enum AuthErrorCode {
	...
	WRONG_TOKEN(401, "DB에 존재하지 않는 토큰입니다."),
	TOKEN_MISMATCH(401, "accessToken과 refreshToken의 정보가 일치하지 않습니다."),
	DUPLICATED_NAME(409, "중복된 이름입니다."),
	ACCESS_IS_EMPTY(400, "accessToken이 비어있습니다.");
